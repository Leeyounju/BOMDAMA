$(function(){
    ...
    //메인메뉴에 마우스오버했을 때 서브메뉴와 서브메뉴배경 나옴(pc버전 네비게이션)
    ...
    var swiper = new Swiper(".mySwiper", {
        ...
        efect:'fade', // fade해야 사라지고 나타나고가 된다
        loof:true, //1-2-3자동
        pagination: {
    ...
    $('#navi nav > ul > li > a').click(function(){
        ...
        //    모든 서브메뉴 들어감
            ...
            // 클릭한 메뉴의 서브메뉴만 나옴. next() : 다음 형제객체를 가리킨다
            $(this).next().slideDown();
            // 클릭한 메뉴에만 active 설정 
